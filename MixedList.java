...
public class MixedList
{
    ...
    public int getInteger(int index)
    {
        ...
        String type = anyTypeValue.getType();
        int value;
    ...
    public int position(int value)
    {
        ...
        for (int i = 0; i < this.mixedList.size(); i++)
        {
            ...
            if ((anyTypeValue.getType()).equals("Integer"))
            {
    ...
    public int position(double value)
    {
        ...
        for (int i = 0; i < this.mixedList.size(); i++)
        {
            ...
            if ((anyTypeValue.getType()).equals("Double"))
            {
    ...
    public int position(char value)
    {
        ...
        for (int i = 0; i < this.mixedList.size(); i++)
        {
            ...
            if ((anyTypeValue.getType()).equals("Character"))
            {
    ...
    public int position(String value)
    {
        ...
        for (int i = 0; i < this.mixedList.size(); i++)
        {
            ...
            if ((anyTypeValue.getType()).equals("String"))
            {
